...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(15)
		::nme::Lib_obj::setPackage(HX_CSTRING("nico"),HX_CSTRING("Cyclope"),HX_CSTRING("com.nicolaspigelet.cyclope.Cyclope"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",40);
			{
				...
				HX_STACK_LINE(49)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::com::nicolaspigelet::cyclope::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(49)
					while(((_g < _g1->length))){
						HX_STACK_LINE(49)
				...
				if ((hasMain)){
					HX_STACK_LINE(59)
					::Reflect_obj::callMethod(hx::ClassOf< ::com::nicolaspigelet::cyclope::Main >(),::Reflect_obj::field(hx::ClassOf< ::com::nicolaspigelet::cyclope::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(64)
					::com::nicolaspigelet::cyclope::Main instance = ::Type_obj::createInstance(hx::ClassOf< ::com::nicolaspigelet::cyclope::Main >(),Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(instance,"instance");
					HX_STACK_LINE(66)
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)31,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("Cyclope"),null());
	}
return null();
}
